...
|en| This software is a sample module that extend res.partner model


|

|it| Questo modulo è un esempio di come estendere la tabella res.partner
...
::
    ...
    sudo manage_odoo requirements -b 6.1 -vsy -o /opt/odoo/6.1
...
Last Update / Ultimo aggiornamento: 2020-02-06
