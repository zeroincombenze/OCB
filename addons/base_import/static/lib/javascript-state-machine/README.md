[![Build Status](https://travis-ci.org/zeroincombenze/javascript-state-machine.svg?branch=10.0)](https://travis-ci.org/zeroincombenze/javascript-state-machine)
[![license agpl](https://img.shields.io/badge/licence-AGPL--3-blue.svg)](http://www.gnu.org/licenses/agpl-3.0.html)
[![Coverage Status](https://coveralls.io/repos/github/zeroincombenze/javascript-state-machine/badge.svg?branch=10.0)](https://coveralls.io/github/zeroincombenze/javascript-state-machine?branch=10.0)
[![codecov](https://codecov.io/gh/zeroincombenze/javascript-state-machine/branch/10.0/graph/badge.svg)](https://codecov.io/gh/zeroincombenze/javascript-state-machine/branch/10.0)
[![OCA_project](http://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-oca-10.svg)](https://github.com/OCA/javascript-state-machine/tree/10.0)
